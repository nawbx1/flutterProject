...
class _AppointmentPageState extends State<AppointmentPage> {
        ...
        appBar: AppBar(
          ...
          bottom: TabBar(
            ...
            tabs: [
              ...
              Tab(
                child: tabItem('refusée', refusedlist !=null ?refusedlist.length :0),
              ),
            ],
          ),
        ),
  ...
  enAttenteAppointments() {
    ...
    Center(
      child: Column(
        ...
        : widget.isProfessionnel ?
    showListFullAppointment(converAppointmentToFullAppointment(enattentelist)) :showListFullAppointment(converAppointmentToLesssAppointment(enattentelist));
  }
  ...
  refusedAppointments() {
    return (refusedlist  == null ||  refusedlist.length == 0)
        ?
    Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        ...
        :
    showListFullAppointment(converAppointmentToLesssAppointment(refusedlist));
  }

...
appointmentTitle: appointmentData !=null && appointmentData.title !=null ?appointmentData.title  :"Rendez-Vous",
                  imgLink: (appointmentData !=null && appointmentData.client !=null
                  ...
                  patienName: appointmentData !=null && appointmentData.client !=null
                      && appointmentData.client.name !=null ? appointmentData.client.name :"Client",
                  patienSurname: appointmentData !=null && appointmentData.client !=null
                      && appointmentData.client.email !=null ? appointmentData.client.email :"mail@bh.tn",
                  appointmentDate: appointmentData !=null && appointmentData.appointmentPK !=null
                && appointmentData.appointmentPK.startDate !=null ?new DateFormat('dd-MM-yyyy').format(appointmentData.appointmentPK.startDate) : "01/04/2021",
                  appointmentTime: appointmentData !=null && appointmentData.appointmentPK !=null
                      && appointmentData.appointmentPK.startDate !=null ?new DateFormat('hh:mm').format(appointmentData.appointmentPK.startDate) : "12:30",
                  onInfoTapped: () {
                    print('info pressed');
                ...
                backCardWidget:AppointmentBackCard(
                  ...
                  launch( appointmentData !=null && appointmentData.client !=null && appointmentData.client.phone !=null ?  "tel://"+appointmentData.client.phone.toString(): "tel://21269974"  );

                  },
                  patientComment: appointmentData !=null && appointmentData.description !=null ? appointmentData.description: "",
                ),
      ),
    );
  }

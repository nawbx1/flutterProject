...
import 'package:doctor_pro/pages/chat/chat.dart';
...
int id;
  ...
  loadContact() async{
    ...
    Response response= await http.get(
        Uri.parse('http://192.168.1.13:8081/msg/getContact/7'),
        headers: {
    ...
    chatList = json.decode(source.toString()) ;
    setState(() {
      chatList;
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: (chatList == null || chatList.length == 0)
          ? Center(
        child: Column(
                ...
                onTap: () {
                  Navigator.push(
                      ...
                      PageTransition(
                          ...
                          child: ChatScreen(name: item['contactName'],targetId:item['contactId'] ,)));
                },
                child: Container(

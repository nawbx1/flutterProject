...
class ArtisanTimeSlot extends StatefulWidget {
  final String artisanName, artisanImage, artisanType, experience;

  const ArtisanTimeSlot(
      {Key key,
      ...
      : super(key: key);
  @override
 ArtisanTimeSlotState createState() => ArtisanTimeSlotState();
}

class ArtisanTimeSlotState extends State<ArtisanTimeSlot> {
  String selectedTime = '';
